...
<img src="marketing/promo/play-store-feature-1024x500.png" alt="밴'S 노트" width="1024" />
...
[웹으로 바로 써보기](https://bandsnote.co.kr) · [**안드로이드 APK 다운로드**](https://github.com/rorena15/band-note-releases/releases/latest)
...
<div align="center">
<img src="marketing/promo/og-share-1200x630.png" width="800" alt="밴'S 노트 소개" />
...
Play스토어를 거치지 않은 설치 방식이라 안드로이드가 보안 경고를 띄웁니다 — 정상입니다, 악성코드가 아니라 사이드로딩이라 뜨는 표준 경고예요.

- **"출처를 알 수 없는 앱" 차단**: 설치를 시도한 앱(브라우저/파일 관리자)에 "이 출처에서 앱 설치 허용"을 눌러주시면 넘어갈 수 있어요.
- **"Play 프로텍트에서 확인할 수 없음" 경고**: "세부정보" → "무시하고 설치" 순으로 진행하시면 됩니다.

경고가 불안하시면, Play스토어 정식 테스터로 등록해서 Play스토어를 통해 안전하게 받으실 수 있어요. 사용 중인 Google 계정 이메일을 [Issues](https://github.com/rorena15/band-note-releases/issues)에 남겨주시면 테스터로 등록해드릴게요 — 등록되면 Play스토어를 거치므로 위 경고들이 뜨지 않습니다. (현재 비공개 테스트 단계라 등록된 분만 참여 가능해요, 정식 공개는 준비 중입니다.)

iOS는 준비 중입니다 — 그동안은 [웹 버전](https://bandsnote.co.kr)을 모바일 브라우저에서 그대로 쓰실 수 있어요 (홈 화면에 추가하면 앱처럼 씁니다).
